...
if __name__ == "__main__":
	...
	file = 'tbinfo_two_sw_lacp.xml'
	tb = parse_tbinfo_untangle(file)
	testtopo_file = 'topo_two_sw_lacp.xml'
	...
	gw4_list = ["10.1.1.212","10.1.1.211","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1","10.1.1.1"]
