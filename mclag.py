...
def collect_ixia_traffic_stats_stable():
	...
	while True:
		...
		if abs(parsed_stats_2[0]["loss_pkts"] - parsed_stats[0]["loss_pkts"]) < 3 :
			return stats
		else:
			debug("1st pkt loss= {}, 2nd pkt loss = {}".format(parsed_stats[0]["loss_pkts"],parsed_stats_2[0]["loss_pkts"]))
...
parser.add_argument("-v", "--verbose", help="Run the test with amble debugs", action="store_true")
...
if dev_mode == False:
	...
	# switch_exec_reboot(dut1,device="dut1")
	# exit()
	...
	# 	d["test"] = i
	# 	d['B4'] = "Test {}".format(i)
	# 	d["sheetname"] = "LACP-2 Test{}".format(i)
...
# #tcl_server=${Ixia Tcl Srv} | device=${Ixia Chasis} | ixnetwork_tcl_server=${Ixia IxNetwork Srv} | port_list=${Ixia ports} | reset=1 |
# portsList = ['1/1','1/2','1/3','1/4']
tprint("===================================== Start to configure IXIA Chassis ============================")
...
tprint("Running traffic for 15 seconds...")
kwargs={}
tkwargs = {}
kwargs = {
        'action':'run',
