...
alias ixiapy='cd /Users/admin/anaconda3/lib/python3.7/site-packages/ixnetwork_restpy'
...
export Tclx="/System/Library/Tcl/"
...
export TCLLIBPATH="$IXOS_API_HOME $HLT_HOME $HLT_LIBRARY ${IXLOAD_HOME}/lib $ixLoadComm $ixTclNetwork $linuxApiServer $Tclx"
...
alias sw548_2='telnet 10.105.50.3 2056'
