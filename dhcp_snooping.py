...
if __name__ == "__main__":
    ...
    #chassis_ip, module,port,mac,ipv4_address/mask, ipv4_gateway,ipv6_address/mask, ipv6_gateway
    ...
    portList = [
    [ixChassisIpList[0], 8, 13,"00:11:01:01:01:01","10.10.1.100/24","10.10.1.254","2001:10:10:1::100/64","2001:10:10:1::254",1], 
    [ixChassisIpList[0], 8, 14,"00:12:01:01:01:01","192.168.1.1/24","192.168.1.254","2001:10:1:1::254/64","2001:10:10:1::254",500],
    [ixChassisIpList[0], 8, 15,"00:13:01:01:01:01","192.168.1.2/24","192.168.1.254","2001:10:1:1::254/64","2001:10:10:1::254",500],
    [ixChassisIpList[0], 8, 16,"00:14:01:01:01:01","10.10.1.1/24","10.10.1.253","2001:10:10:1::1/64","2001:10:10:1::253",1]
    ]
    ...
    myixia.topologies[0].dhcp_server_address_v6(start_ip = "2001:10:10:1::2",prefix=32)
    ...
    myixia.topologies[3].dhcp_server_gw_v6(gateway="2001:10:20:1::1")
    myixia.topologies[3].dhcp_server_pool_size_v6(pool_size = 2000)
    myixia.topologies[3].dhcp_server_address_v6(start_ip = "2001:10:20:1::2",prefix=32)
    ...
    wait_time = 80
    myixia.start_protocol(wait=wait_time)
    ...
    dut1_com = "10.105.240.44"
    dut1_port = 2093

    dut2_com = "10.105.240.144"
    dut2_port = 2087
    ...
    while True:
        myixia.stop_protocol(wait=wait_time)
        switch_exec_cmd(dut1,"execute dhcp-snooping expire-server 1")
        switch_exec_cmd(dut1,"execute dhcp-snooping expire-client 1")
        switch_exec_cmd(dut2,"execute dhcp-snooping expire-server 1")
        switch_exec_cmd(dut2,"execute dhcp-snooping expire-client 1")
        console_timer(30,msg="Wait for 30 after protocols are stopped")
        myixia.start_protocol(wait=wait_time)
        console_timer(120,msg="Wait for 2 minute after protocols are started")
