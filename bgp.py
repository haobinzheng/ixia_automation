...
if testcase == 7:
	...
	while True:
		...
		switch_show_cmd(dut1,"get system performance status")
		switch_show_cmd(dut1,"get hardware cpu")
		switch_show_cmd(dut1,"get hardware memory")
		sw_display_log(dut1,lines = 100)
		mesg = loop_command_output(dut1,'fnsys top')
		print_cmd_output(mesg,dut_name,"fnsys top")
		switch_system_interface_shut(dut1,'mgmt')
		sleep(1)
		switch_system_interface_unshut(dut1,'mgmt')
		sleep(5)
...
for each mac_size:
	...
	for mac_table in mac_list:
		...
		topo_h3 = topo_list[2]
		topo_h4 = topo_list[3]
		ixia_start_protcols_verify(dhcp_handle_list,timeout=20)
