...
if soak == 1:
	...
	for i in range (1,2):
		...
		if flag_pw_scaleout == 1:
			num = 3000
			dut_A = CN_5142_A(sw_5142_A)
			dut_A.configuration_vs(num)
			dut_A.configuration_pw(num)
			dut_A.configuration_attach_vs(num)
			dut_A.configuration_attach_port(num)
			dut_B = CN_8700_B(sw_8700_B)
			dut_B.configuration_vs(num)
			dut_B.configuration_pw(num)
			dut_B.configuration_attach_vs(num)
			dut_C = CN_8700_C(sw_8700_C)
			dut_C.configuration_vs(num)
			dut_C.configuration_pw(num)
			dut_C.configuration_attach_vs(num)
			mpls_pw = mpls_l2vpn(dut_A)
			mpls_pw.mpls_vc_stats()
		...
		if flag_builds_comp == 1:
			...
			dut_A = CN_5142_A(sw_5142_A)
			dut_J = CN_5160_J(sw_5160_J)
			result = sw_show_cmd(dut_A,'software show')
			print result
			bfd_result = sw_show_cmd(dut_A,'bfd show')
			print bfd_result
			bfd_result = sw_show_cmd(dut_A,'bfd session show')
			print bfd_result
			result = sw_show_cmd(dut_J,'software show')
			print result
			bfd_result = sw_show_cmd(dut_J,'bfd show')
			print bfd_result
			bfd_result = sw_show_cmd(dut_J,'bfd session show')
			print bfd_result
			...
			bfd_result = sw_show_cmd(dut_A,'bfd show')
			print bfd_result
			bfd_result = sw_show_cmd(dut,'bfd session show')
			print bfd_result
			result = sw_show_cmd(dut_J,'software show')
			print result
			bfd_result = sw_show_cmd(dut_J,'bfd show')
			...
			bfd_result = sw_show_cmd(dut_J,'bfd session show')
			print bfd_result
		if flag_ais_profiles == 1:
			dut_A = CN_5142_A(sw_5142_A)
			case_sweeping_ais_profiles(dut_A)
